...
<head>
    ...
    <title>Quizzes - Study First</title>
    ...
    <style>
        body {
            ...
            margin: 20px;
            font-size: 16px;
            background: linear-gradient(#e09704, #e0b404, #e0ca04, #e0e004, #d1e004);
        ...
        .navbar {
            background: linear-gradient(#dba309, #d3b107, #d5d50c);
            padding: 20px;
            display: flex;
            gap: 5px;
            border-radius: 8px;
...
<body>
    ...
    <h2>Study First-Quizzes</h2>
    <p>Welcome to the quizzes page!</p>
